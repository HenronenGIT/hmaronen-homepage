...
export const SectionSubtitle: React.FC<Omit<TypographyProps, 'variant' | 'as'>> = (props) => (
  <Typography variant="section-subtitle" as="h3" {...props} />
);

// Body text components
export const BodyLarge: React.FC<Omit<TypographyProps, 'variant' | 'as'>> = (props) => (
...
export const BodySmall: React.FC<Omit<TypographyProps, 'variant' | 'as'>> = (props) => (
...
export const Micro: React.FC<Omit<TypographyProps, 'variant' | 'as'>> = (props) => (
...
export const Metadata: React.FC<Omit<TypographyProps, 'variant' | 'as'>> = (props) => (
  <Typography variant="metadata" as="p" {...props} />
);

export const Tag: React.FC<Omit<TypographyProps, 'variant' | 'as'>> = (props) => (
  <Typography variant="tag" as="span" {...props} />
);

export const Badge: React.FC<Omit<TypographyProps, 'variant' | 'as'>> = (props) => (
...
export default {
  ...
  BodyLarge, Body, BodySmall, Caption, Micro,
  Label, Metadata, Tag, Badge,
};