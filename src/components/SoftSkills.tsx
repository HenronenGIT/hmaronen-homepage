...
const PassionCard = ({ passion }: { passion: Passion }) => (
  <div
      ...
      <div className="max-w-7xl mx-auto space-y-12 md:space-y-20">
        ...
        <div className="space-y-8 md:space-y-12">
          <h3 className="text-2xl md:text-3xl font-bold text-center font-heading mb-8 md:mb-12">
            Personal <span style={{ color: COLORS.primary }}>Strengths</span>
          </h3>
        ...
        <div className="space-y-8 md:space-y-12">
          <h3 className="text-2xl md:text-3xl font-bold text-center font-heading mb-8 md:mb-12">
            Beyond <span style={{ color: COLORS.primary }}>Code</span>
          </h3>
