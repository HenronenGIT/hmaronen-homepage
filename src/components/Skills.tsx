  ...
  const technicalSkills = [
    ...
    },
    {
      ...
      items: [
        ...
        // {
        //   name: "Cursor",
        //   logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/cursor/cursor-original.svg",
        // },
        {
          name: "VS Code",
        ...
        // {
        //   name: "Linear",
        //   logo: "https://www.svgrepo.com/show/354012/linear.svg",
        // },
      ],
    },
  ];
              ...
              {technicalSkills.map((skill, index) => (
                ...
                >
                  <div className="flex items-center mb-4">
                    ...
                    />
                    <h4
                      className="text-xl font-bold group-hover:opacity-80 transition-colors font-heading"
                      style={{ color: "#4FD1C7" }}
                    >
                      {skill.category}
                    </h4>
                ...
                >
                  ...
                  <ul className="space-y-2">
                    {skill.items.map((item) => (
                      <li
                        key={item}
                        className="text-gray-300 group-hover:text-white transition-colors font-sans"
                      >
                        {item}
                      </li>
                    ))}
