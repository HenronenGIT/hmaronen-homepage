...
export const TYPOGRAPHY = {
  ...
  presets: {
    ...
    'metadata': 'text-sm font-medium text-gray-400 uppercase tracking-wider font-heading',
...
export const getTypographyPreset = (preset: keyof typeof TYPOGRAPHY.presets, overrides?: string) => {
